function lastPosts(t) {
  for(i = 0; i < t.feed.entry.length; i++) {
    ...
    var v = e.replace("s72-c", "s1600"),
        p = l.published.$t,
        f = p.substring(0, 10),
        u = '<div class="box"><time class="meta-label label-'+ PostsLabelFirst +'" datetime="' + p + '" title="' + f + '"><span class="meta-icon far fa-clock"></span>'+ f +'</time><a class="thumbnail" href="' + r + '"><img loading="lazy" class="swiper-lazy lazy" data-src="' + v + '" alt="' + n + '"></a><div class="box-content"><h2 class="post-headding"><a class="link" href="' + r + '">' + n + "</a></h2></div></div>";
